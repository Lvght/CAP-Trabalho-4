...
//essa fun��o recebe o diretorio do arquivo de registro dos usuarios, o id de quem fez a postagem e a intera��o (like/deslike)
...
int main()
{
    ...
    //armazena o id de quem postou o arquivo na variavel para ser usado na fun��o logo abaixo.
    ...
    else
    {
        ...
        //caso o like seja contabilizado, ser� chamada a fun��o que altera a pontua��o
